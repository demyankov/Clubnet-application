export const en = {
  translation: {
    ...
    form: {
      'signin-header': 'Sign in with you phone number',
      'your-phone': 'Your phone',
      'phone-format': 'Enter you phone number including country code',
      'send-sms': 'Send SMS with code',
      'phone-again': 'Enter phone again',
      send: 'Send',
    },
    footer: {
    ...
    notifications: {
      ...
      'error-header': 'Error',
      'common-success': 'Congratulations!',
